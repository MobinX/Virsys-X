...
const Card = ({e}) => {
  return (
    <div className="bg-[#92a5c2] grid w-full md:w-1/2 flex-grow gap-3 rounded-xl  p-6 shadow-xl">
...
export default function About() {
  const { txt, mobinInfoh1, mobinInfop, shihabInfoh1, shihabInfop } = contant;
  return (
    <div className="col center mt-10 font-mono text-teal-300 over space-y-4">
